...
class TrackOrderModel {
    ...
    static func sendRequestToServerWithParam(baseUrl: String, _ url: String, httpMethod: String, isZipped: Bool,param:[String: Any], receivedResponse:@escaping (_ succeeded: Bool, _ response: [String: Any]) -> Void ) {
...
//        let newParam: [String: Any] = [:]
        ...
        request.timeoutInterval = 20
          ...
          if isZipped == false {
              request.addValue("Bearer: \(accessToken ?? "")", forHTTPHeaderField: "access-token")
            request.addValue("application/json", forHTTPHeaderField: "Content-Type")
          } else {
            request.addValue("application/octet-stream", forHTTPHeaderField: "Content-Type")
            request.addValue("application/octet-stream", forHTTPHeaderField: "Content-Encoding: gzip")
